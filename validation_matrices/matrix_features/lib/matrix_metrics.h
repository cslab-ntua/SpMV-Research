...
static
void
MATRIX_METRICS_min_max(void * A, long N, double * min, double * max, double (* get_val_as_double)(void * A, int i))
{
...
static
double
MATRIX_METRICS_mean(void * A, long N, double (* get_val_as_double)(void * A, int i))
{
	int num_threads = omp_get_max_threads();
...
static
double
MATRIX_METRICS_var(void * A, long N, double mean, double (* get_val_as_double)(void * A, int i))
{
	int num_threads = omp_get_max_threads();
	double sums[num_threads];
	double sum = 0;
