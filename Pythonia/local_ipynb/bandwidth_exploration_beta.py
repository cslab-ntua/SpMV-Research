...
def bandwidth_exploration(filename, parts, strat, plot_it):
    ...
    if(strat == "bw-distrib"):
        ...
        bandwidth_parts = partial_bandwidth_calculation2(row_ptr, col_ind, bandwidth, parts)
...
def wrapper(filenames, parts, strat, plot_it):
    ...
    file1 = open("/various/pmpakos/SpMV-Research/Pythonia/local_ipynb/bandwidth_exploration_"+str(parts)+"_parts_"+strat+"_stats_bw_beta.txt","w")
    file2 = open("/various/pmpakos/SpMV-Research/Pythonia/local_ipynb/bandwidth_exploration_"+str(parts)+"_parts_"+strat+"_stats_sc_beta.txt","w")
