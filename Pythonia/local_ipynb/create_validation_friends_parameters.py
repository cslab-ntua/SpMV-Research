...
def create_param_file(param_file, mem_range_list, matrices_per_mem_range, avg_nnz_per_row_list, avg_bw_list, distribution, placement, skew_coeff_list, avg_num_neigh_list, cross_row_similarity_list, seed):
        ...
        for size in sizes:
            ...
            for avg_nnz_per_row in avg_nnz_per_row_list:
                ...
                for avg_bw in avg_bw_list:
                    for skew_coeff in skew_coeff_list:
                        for avg_num_neigh in avg_num_neigh_list:
                            for cross_row_similarity in cross_row_similarity_list:
                                line = [nr_rows, nr_cols, avg_nnz_per_row, std_nnz_per_row, distribution, placement, avg_bw, skew_coeff, avg_num_neigh, cross_row_similarity, seed]
