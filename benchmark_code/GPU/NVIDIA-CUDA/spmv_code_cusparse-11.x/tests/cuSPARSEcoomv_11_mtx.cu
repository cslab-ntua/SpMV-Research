...
int main(int argc, char **argv) {
	...
	sprintf(powa_filename, "cuSPARSEcoomv_11-0_mtx_cudatype-%d_format-COO.log", CUDA_VALUE_TYPE_AX);
	...
	NvemStats_p nvem_data = NvemStopMeasure(device_id, "Energy measure cuSPARSEcoomv_11-0_mtx");
