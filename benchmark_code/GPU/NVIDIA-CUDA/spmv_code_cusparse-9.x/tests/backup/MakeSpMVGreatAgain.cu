...
int main(int argc, char **argv) {
  ...
  massert(argc == 4 || argc ==5,
          "Incorrect arguments.\nUsage:\t./Executable logfilename spmv_implementation [blockdim] Matrix_name.mtx");
  ...
  int impFlag = 0, blockdim = 4; /// Default case; run ALL versions (might break)
  void *y_out, *y_out1;
  ...
  VALUE_TYPE *out = (VALUE_TYPE *)calloc(op.m, sizeof(VALUE_TYPE));
