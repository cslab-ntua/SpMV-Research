...
__device__
void
spmv_last_warps(group_t g, int m, int last_warp_num_active_threads, int i, int j_w_s, int j_b_s, INT_T * row_ptr, INT_T * ja, ValueType * a, ValueType * restrict x, ValueType * restrict y)
{
...
__device__
void
spmv_full_warp_last_block(group_t g, int i, int j_w_s, int j_b_s, INT_T * row_ptr, INT_T * ja, ValueType * a, ValueType * restrict x, ValueType * restrict y)
{
	// extern __shared__ double x_smem[];
	const int tidw = g.thread_rank();   // Group lane.
	int j, jj, j_s, j_e;
...
spmv_last_block(INT_T * row_ptr, INT_T * ja, ValueType * a, long m, long n, long nnz, ValueType * restrict x, ValueType * restrict y, int num_active_threads)
{
	...
	// j_b_s = row_ptr[block_id * BLOCK_SIZE];
	i_s = tid;
...
__device__
void
spmv_full_warp(group_t g, int i, int j_w_s, int j_b_s, INT_T * row_ptr, INT_T * ja, ValueType * a, ValueType * restrict x, ValueType * restrict y)
{
	// extern __shared__ double x_smem[];
	const int tidw = g.thread_rank();   // Group lane.
	int j, jj, j_s, j_e;
