...
progs=(
    ...
    # ['csr_cuda_const_nnz_per_thread_transpose_nv_d']="${script_dir}/src/spmv_csr_cuda_const_nnz_per_thread_transpose_nv_d.exe"
    # ['csr_cuda_const_nnz_per_thread_transpose_coo_nv_d']="${script_dir}/src/spmv_csr_cuda_const_nnz_per_thread_transpose_coo_nv_d.exe"
    # ['csr_cuda_const_nnz_per_thread_transpose_coo_delta_nv_d']="${script_dir}/src/spmv_csr_cuda_const_nnz_per_thread_transpose_coo_delta_nv_d.exe"
    ['csr_cuda_const_nnz_per_thread_transpose_coo_non_empty_rows_nv_d']="${script_dir}/src/spmv_csr_cuda_const_nnz_per_thread_transpose_coo_non_empty_rows_nv_d.exe"
