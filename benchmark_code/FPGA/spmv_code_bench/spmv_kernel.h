...
struct Matrix_Format
{
	...
	virtual void copy_to_device(ValueType * x) = 0;
	virtual void copy_from_device(ValueType * y) = 0;
...
struct Matrix_Format * csr_to_format(INT_T * row_ptr, INT_T * col_ind, ValueType * values, long m, long n, long nnz, ValueType * x);
