...
conf_vars=(
    ...
    ['path_validation']="$( options=(
                        ...
                        # '/various/pmpakos/SpMV-Research2/validation_matrices/test/'
                    )
    ...
    # Xilinx Vitis related stuff
    # gold2 setup
    ['XILINX_XRT']="/opt/xilinx/xrt"
    ['XILINX_VIVADO']="/various/common_tools/xilinx_stx/Vivado/2020.2/"
    ['XILINX_VITIS']="/various/common_tools/xilinx_stx/Vitis/2020.2/"
    ['XILINX_VITIS_HLS']="/various/common_tools/xilinx_stx/Vitis_HLS/2020.2/"
    ['VITIS_PLATFORM']="xilinx_u280_xdma_201920_3"
    ['DEV_ID']="0000:5e:00.1" # can be retrieved with "xbutil scan"

    # magneto setup
    # ['XILINX_XRT']="/opt/xilinx/xrt"
    # ['XILINX_VIVADO']="/opt/Xilinx/Vivado/2022.1/"
    # ['XILINX_VITIS']="/opt/Xilinx/Vitis/2022.1/"
    # ['XILINX_VITIS_HLS']="/opt/Xilinx/Vitis_HLS/2022.1/"
    # ['VITIS_PLATFORM']="xilinx_u55c_gen3x16_xdma_base_3"
    # ['DEV_ID']="0000:0a:00.1"

    # ['CU']=2
    # ['XCLBIN_FILENAME']="/various/pmpakos/SpMV-Research/benchmark_code/FPGA/spmv_code_bench/optima/optima_spmv/Hardware/binary_container_1_CU2.xclbin"
    ['CU']=10
    ['XCLBIN_FILENAME']="/various/pmpakos/SpMV-Research/benchmark_code/FPGA/spmv_code_bench/optima/optima_spmv/Hardware/binary_container_1_CU10.xclbin"
    ['KERNEL_NAME']="krnl_spmv" # in case we test anything else in the future... configurable for use in "oops.hpp"
)
