...
bench()
{
    ...
    for group_size in $group_sizes; do                      
        ...
        do
            ...
            echo "File: ${prog_args}" 1>>arm_library_t${t}_d.out
            "${interleaved[@]}" "$prog" "${prog_args[@]}" 1>>arm_library_t${t}_d.out 2>>arm_10_samples_30_range_t${t}_d.csv
