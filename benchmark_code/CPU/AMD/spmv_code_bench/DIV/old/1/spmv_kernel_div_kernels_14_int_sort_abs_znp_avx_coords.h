...
static inline
void
gather_coords_sparse_r1_c1(long i, unsigned char * data_coords, const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m128i * row_rel_out, __m128i * col_rel_out)
{
	__m128i row_rel, col_rel;
	row_rel = _mm_set_epi32(data_coords[(i+3)*coords_bytes], data_coords[(i+2)*coords_bytes], data_coords[(i+1)*coords_bytes], data_coords[i*coords_bytes]);
	col_rel = _mm_set_epi32(data_coords[(i+3)*coords_bytes + 1], data_coords[(i+2)*coords_bytes + 1], data_coords[(i+1)*coords_bytes + 1], data_coords[i*coords_bytes + 1]);
	*row_rel_out = row_rel;
	*col_rel_out = col_rel;
}
...
static inline
void
gather_coords_sparse_r1_c2(long i, unsigned char * data_coords, const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m128i * row_rel_out, __m128i * col_rel_out)
{
	__m128i row_rel, col_rel;
	row_rel = _mm_set_epi32(data_coords[(i+3)*coords_bytes], data_coords[(i+2)*coords_bytes], data_coords[(i+1)*coords_bytes], data_coords[i*coords_bytes]);
	col_rel = _mm_set_epi32(*((uint16_t *) &data_coords[(i+3)*coords_bytes + 1]), *((uint16_t *) &data_coords[(i+2)*coords_bytes + 1]), *((uint16_t *) &data_coords[(i+1)*coords_bytes + 1]), *((uint16_t *) &data_coords[i*coords_bytes + 1]));
	*row_rel_out = row_rel;
	*col_rel_out = col_rel;
}
...
static inline
void
gather_coords_sparse_r1_c3(long i, unsigned char * data_coords, const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m128i * row_rel_out, __m128i * col_rel_out)
{
...
static inline
void
gather_coords_sparse_r1_c4(long i, unsigned char * data_coords, const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m128i * row_rel_out, __m128i * col_rel_out)
{
	__m128i row_rel, col_rel;
	row_rel = _mm_set_epi32(data_coords[(i+3)*coords_bytes], data_coords[(i+2)*coords_bytes], data_coords[(i+1)*coords_bytes], data_coords[i*coords_bytes]);
	col_rel = _mm_set_epi32(*((uint32_t *) &data_coords[(i+3)*coords_bytes + 1]), *((uint32_t *) &data_coords[(i+2)*coords_bytes + 1]), *((uint32_t *) &data_coords[(i+1)*coords_bytes + 1]), *((uint32_t *) &data_coords[i*coords_bytes + 1]));
		...
		void (* gather_coords)(long i, unsigned char * data_coords, const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, __m128i * row_rel_out, __m128i * col_rel_out))
{
	...
	else
	{
		...
		y_rel[row_rel.u[0]] += val.d[0] * x_rel[col_rel.u[0]];
		y_rel[row_rel.u[1]] += val.d[1] * x_rel[col_rel.u[1]];
		y_rel[row_rel.u[2]] += val.d[2] * x_rel[col_rel.u[2]];
		y_rel[row_rel.u[3]] += val.d[3] * x_rel[col_rel.u[3]];

		// y_buf[0][row_rel.u[0]] += val.d[0] * x_rel[col_rel.u[0]];
		// y_buf[1][row_rel.u[1]] += val.d[1] * x_rel[col_rel.u[1]];
		// y_buf[2][row_rel.u[2]] += val.d[2] * x_rel[col_rel.u[2]];
		// y_buf[3][row_rel.u[3]] += val.d[3] * x_rel[col_rel.u[3]];
	...
	for (i=4;i<num_vals_padded;i+=4)
	{
		...
		else
		{
			...
			// v_x = _mm256_set_pd(x_rel[col_rel.u[3]], x_rel[col_rel.u[2]], x_rel[col_rel.u[1]], x_rel[col_rel.u[0]]);
			// v_tmp = val.d * v_x;
			// y_buf[row_rel.u[0]] += v_tmp[0];
			// y_buf[row_rel.u[1]] += v_tmp[1];
			// y_buf[row_rel.u[2]] += v_tmp[2];
			// y_buf[row_rel.u[3]] += v_tmp[3];
