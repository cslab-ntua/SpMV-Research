...
void test_file(string filename, double *mkl_time)
{
...
int main()
{
    ...
    cout << "mkl, max thread:" << THREAD_NUM << endl;

    // string input_file_path = "./in/matrix101.txt";
    // string output_file_path = "./out/matrix_mkl_0316_thread48.txt";
    ...
    // for(int i=0; i<10; i++){
    //     test_file("../matrix93/cage14.mtx", &mkl_time);
    //     ofs << file_name << " " << mkl_time << endl;
    // }
