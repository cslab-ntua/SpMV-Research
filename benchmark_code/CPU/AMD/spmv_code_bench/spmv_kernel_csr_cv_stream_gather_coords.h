...
static __attribute__((always_inline)) inline
void
gather_coords_dense_v4(long i, unsigned char * data_coords, const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	/* The row + col bytes can be more than 4 in total, so we need uint64_t.
	 */
...
static __attribute__((always_inline)) inline
void
gather_coords_dense_1_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	const __m256i row_bits_mask = _mm256_set1_epi64x((1ULL<<row_bits) - 1);   // here '-' has precedence over '<<'!
	__m256i coords;
...
static __attribute__((always_inline)) inline
void
gather_coords_dense_2_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	const __m256i row_bits_mask = _mm256_set1_epi64x((1ULL<<row_bits) - 1);   // here '-' has precedence over '<<'!
	__m256i coords;
...
static __attribute__((always_inline)) inline
void
gather_coords_dense_3_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	const __m256i row_bits_mask = _mm256_set1_epi64x((1ULL<<row_bits) - 1);   // here '-' has precedence over '<<'!
	__m256i coords;
...
static __attribute__((always_inline)) inline
void
gather_coords_dense_4_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, uint64_t row_bits, uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	const __m256i row_bits_mask = _mm256_set1_epi64x((1ULL<<row_bits) - 1);   // here '-' has precedence over '<<'!
	__m256i coords;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r0_v4(long i, unsigned char * data_coords, const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 0");
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r0_c1_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 0,1");
	__m256i col_rel;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r0_c2_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 0,2");
	__m256i col_rel;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r0_c3_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 0,3");
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r0_c4_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 0,4");
	__m256i col_rel;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r1_v4(long i, unsigned char * data_coords, const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	const __m256i col_bits_mask = _mm256_set1_epi64x((1ULL<<col_bits) - 1);
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r1_c1_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 1\n");
	__m256i row_rel, col_rel;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r1_c2_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 2");
	__m256i row_rel, col_rel;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r1_c3_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 3");
	const __m256i col_bits_mask = _mm256_set1_epi64x((1ULL<<24) - 1);
	__m256i row_rel, col_rel;
...
static __attribute__((always_inline)) inline
void
gather_coords_sparse_r1_c4_v4(long i, unsigned char * data_coords, __attribute__((unused)) const uint64_t coords_bytes, __attribute__((unused)) uint64_t row_bits, __attribute__((unused)) uint64_t col_bits, __m256i * row_rel_out, __m256i * col_rel_out)
{
	// error("test 4");
	__m256i row_rel, col_rel;
