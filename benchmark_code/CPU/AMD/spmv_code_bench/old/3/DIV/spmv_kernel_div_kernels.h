...
static inline
long
compress_kernel_div(INT_T * row_ptr, INT_T * ja, ValueTypeReference * vals, long i_s, [[gnu::unused]] long i_t_s, [[gnu::unused]] long i_t_e, long j_s, unsigned char * buf, long num_vals, long * num_vals_out, [[gnu::unused]] long symmetric)
{
	int tnum = omp_get_thread_num();
	struct thread_data * td = tds[tnum];
	...
	ValueType tolerance = atof(getenv("DIV_VC_TOLERANCE"));
