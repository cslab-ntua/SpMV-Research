...
static inline
long
compress_kernel_div(INT_T * row_ptr, INT_T * ja, ValueTypeReference * vals, long i_s, long i_t_s, long i_t_e, long j_s, unsigned char * buf, long num_vals, long * num_vals_out, long symmetric)
{
	int tnum = omp_get_thread_num();
	struct thread_data_kernel * tdk = tdks[tnum];
	long num_vals_sym;
	...
	num_vals = k;
	// printf("compress_kernel_div: num_vals=%ld, num_vals_sym=%ld\n", num_vals, num_vals_sym);
