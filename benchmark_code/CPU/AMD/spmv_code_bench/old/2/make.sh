...
CFLAGS+=" -D'LEVEL1_DCACHE_LINESIZE=$(read v < /sys/devices/system/cpu/cpu0/cache/index0/coherency_line_size; echo ${v%K})ULL'"
CFLAGS+=" -D'LEVEL1_DCACHE_SIZE=$(read v < /sys/devices/system/cpu/cpu0/cache/index0/size; echo $((${v%K} * 1024)) )ULL'"
CFLAGS+=" -D'LEVEL2_CACHE_SIZE=$(read v < /sys/devices/system/cpu/cpu0/cache/index2/size; echo $((${v%K} * 1024)) )ULL'"
CFLAGS+=" -D'LEVEL3_CACHE_SIZE=$(read v < /sys/devices/system/cpu/cpu0/cache/index3/size; echo $((${v%K} * 1024)) )ULL'"
