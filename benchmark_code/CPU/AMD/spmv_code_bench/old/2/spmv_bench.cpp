...
compute(char * matrix_name,
		__attribute__((unused)) INT_T * csr_ia, __attribute__((unused)) INT_T * csr_ja, double * csr_a_ref, INT_T csr_m, INT_T csr_n, INT_T csr_nnz, __attribute__((unused)) INT_T csr_nnz_diag, __attribute__((unused)) INT_T csr_nnz_non_diag, __attribute__((unused)) int csr_symmetric,
...
main(int argc, char **argv)
{
	...
	if (argc == 1)
	{
		compute(NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 0, 1, 0);
		return 0;
	}
...
child_proc_label:
	...
	time = time_it(1,
		// for (i=0;i<5;i++)
		{
			...
			compute(matrix_name,
				csr_ia, csr_ja, csr_a_ref, csr_m, csr_n, csr_nnz, csr_nnz_diag, csr_nnz_non_diag, csr_symmetric,
