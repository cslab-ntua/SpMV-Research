first of all, include cmake and hwloc in path (cmake is already installed in ARM machine...no need to include it)
	export PATH=/home/pmpakos/ESSEX/cmake-3.23.3/build/bin:/home/pmpakos/ESSEX/hwloc-1.11.13/build/bin:$PATH
...
ghost : cmake in "build" directory with command
	cmake .. -DCMAKE_INSTALL_PREFIX=/home/pmpakos/ESSEX/ghost/build -DHWLOC_INCLUDE_DIR=/home/pmpakos/ESSEX/hwloc-1.11.13/build/include -DGHOST_USE_MPI=0
...
---
physics : 
	cmake .. -DCMAKE_INSTALL_PREFIX=/home/pmpakos/ESSEX/physics/build -DGHOST_DIR=/home/pmpakos/ESSEX/ghost/build/lib/ghost/  -DFFTW3_INCLUDE_DIR=/home/pmpakos/ESSEX/fftw-3.3.10/build/include/ -DFFTW3_LIBRARY=/home/pmpakos/ESSEX/fftw-3.3.10/build/lib
	make -j80; make install
	...
	before running "make"
		...
		2) Needed to build FFTW3 library from source
			...
			./configure --prefix=/home/pmpakos/ESSEX/fftw-3.3.10/build/
...
---
ghost-apps : 
	cmake .. -DCMAKE_INSTALL_PREFIX=/home/pmpakos/ESSEX/ghost-apps/build -DGHOST_DIR=/home/pmpakos/ESSEX/ghost/build/lib/ghost/ -DESSEX-PHYSICS_DIR=/home/pmpakos/ESSEX/physics/build/lib/essex-physics/
	make -j20
	...
	d) build/spmvbench/CMakeFiles/spmvbench.dir/build.make : 
		...
		iii) Add following rules, for object files of artificial-matrix-generator to be built
				...
				CMakeFiles/spmvbench.dir/artificial_matrix_generation.o: ${AMG_PATH}/artificial_matrix_generation.c
					cd /home/pmpakos/ESSEX/ghost-apps/build/spmvbench && /usr/bin/cc -o $@ -c $< ${AMG_CFLAGS}
