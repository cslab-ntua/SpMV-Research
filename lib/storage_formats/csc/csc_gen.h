...
void csc_sort_rows(_TYPE_I * row_idx, _TYPE_I * col_ptr, _TYPE_V * val, long m, long n, long nnz);


#undef  coo_to_csc
#define coo_to_csc  CSC_GEN_EXPAND(coo_to_csc)
void coo_to_csc(_TYPE_I * R, _TYPE_I * C, _TYPE_V * V, long m, long n, long nnz, _TYPE_I * row_idx, _TYPE_I * col_ptr, _TYPE_V * val, int sort_rows);
