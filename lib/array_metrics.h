...
struct ARRAY_METRICS_mape_s {
	struct ARRAY_METRICS_mare_s mare_s;
};
...
struct ARRAY_METRICS_smape_s {
	struct ARRAY_METRICS_smare_s smare_s;
};
...
struct ARRAY_METRICS_mlare_s {
	...
	// double partial;
	// double * result_out;
	struct ARRAY_METRICS_lnQ_error_s lnQ_error_s;
};

void ARRAY_METRICS_mlare_init(int concurrent, struct ARRAY_METRICS_mlare_s * s, void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_mlare_process(struct ARRAY_METRICS_mlare_s * s, long i, double (* get_val_as_double)(void * A, long i));
struct ARRAY_METRICS_mlare_s ARRAY_METRICS_mlare_combine(struct ARRAY_METRICS_mlare_s s1, struct ARRAY_METRICS_mlare_s s2);
void ARRAY_METRICS_mlare_finalize(struct ARRAY_METRICS_mlare_s * s);
void ARRAY_METRICS_mlare_output(struct ARRAY_METRICS_mlare_s * s_local, struct ARRAY_METRICS_mlare_s * s_global);

void ARRAY_METRICS_mlare_serial(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_mlare_concurrent(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_mlare(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));

#define array_seg_mlare_serial(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_mlare_serial(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_mlare_serial(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_mlare_serial(A, F, 0, N, result_out, ##__VA_ARGS__)

#define array_seg_mlare_concurrent(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_mlare_concurrent(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_mlare_concurrent(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_mlare_concurrent(A, F, 0, N, result_out, ##__VA_ARGS__)

#define array_seg_mlare(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_mlare(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_mlare(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_mlare(A, F, 0, N, result_out, ##__VA_ARGS__)
...
struct ARRAY_METRICS_gmare_s {
	struct ARRAY_METRICS_mlare_s mlare_s;
};

void ARRAY_METRICS_gmare_init(int concurrent, struct ARRAY_METRICS_gmare_s * s, void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_gmare_process(struct ARRAY_METRICS_gmare_s * s, long i, double (* get_val_as_double)(void * A, long i));
struct ARRAY_METRICS_gmare_s ARRAY_METRICS_gmare_combine(struct ARRAY_METRICS_gmare_s s1, struct ARRAY_METRICS_gmare_s s2);
void ARRAY_METRICS_gmare_finalize(struct ARRAY_METRICS_gmare_s * s);
void ARRAY_METRICS_gmare_output(struct ARRAY_METRICS_gmare_s * s_local, struct ARRAY_METRICS_gmare_s * s_global);

void ARRAY_METRICS_gmare_serial(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_gmare_concurrent(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_gmare(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));

#define array_seg_gmare_serial(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_gmare_serial(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_gmare_serial(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_gmare_serial(A, F, 0, N, result_out, ##__VA_ARGS__)

#define array_seg_gmare_concurrent(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_gmare_concurrent(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_gmare_concurrent(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_gmare_concurrent(A, F, 0, N, result_out, ##__VA_ARGS__)

#define array_seg_gmare(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_gmare(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_gmare(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_gmare(A, F, 0, N, result_out, ##__VA_ARGS__)
...
void ARRAY_METRICS_smlare_init(int concurrent, struct ARRAY_METRICS_smlare_s * s, void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_smlare_process(struct ARRAY_METRICS_smlare_s * s, long i, double (* get_val_as_double)(void * A, long i));
struct ARRAY_METRICS_smlare_s ARRAY_METRICS_smlare_combine(struct ARRAY_METRICS_smlare_s s1, struct ARRAY_METRICS_smlare_s s2);
void ARRAY_METRICS_smlare_finalize(struct ARRAY_METRICS_smlare_s * s);
void ARRAY_METRICS_smlare_output(struct ARRAY_METRICS_smlare_s * s_local, struct ARRAY_METRICS_smlare_s * s_global);

void ARRAY_METRICS_smlare_serial(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_smlare_concurrent(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));
void ARRAY_METRICS_smlare(void * A, void * F, long i_start, long i_end, double * result_out, double (* get_val_as_double)(void * A, long i));

#define array_seg_smlare_serial(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_smlare_serial(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_smlare_serial(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_smlare_serial(A, F, 0, N, result_out, ##__VA_ARGS__)

#define array_seg_smlare_concurrent(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_smlare_concurrent(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_smlare_concurrent(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_smlare_concurrent(A, F, 0, N, result_out, ##__VA_ARGS__)

#define array_seg_smlare(A, F, i_start, i_end, result_out, ... /* get_val_as_double() */)    \
	ARRAY_METRICS_smlare(A, F, i_start, i_end, result_out, DEFAULT_ARG_1(gen_functor_convert_basic_type_to_double(A), ##__VA_ARGS__))

#define array_smlare(A, F, N, result_out, ... /* get_val_as_double() */)    \
	array_seg_smlare(A, F, 0, N, result_out, ##__VA_ARGS__)
