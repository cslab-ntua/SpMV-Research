...
typedef struct [[gnu::packed]] { __m512i v[2]; }  __m512i_i32_2;
#define vec_i32_32_t  __m512i_i32_2
#define vec_i32_16_t  __m512i
...
#define vec_set1_i32_32(val)                     vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_set1_i32_16(val);)
#define vec_set1_i32_16(val)                     _mm512_set1_epi32(val)
#define vec_set1_i32_8(val)                      _mm256_set1_epi32(val)
#define vec_set1_i32_4(val)                      _mm_set1_epi32(val)
#define vec_set1_i32_1(val)                      val

#define vec_set_iter_i32_32(iter, expr)          vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = _mm512_set_epi32(vec_iter_expr_16(iter, 16*_i, expr));)
#define vec_set_iter_i32_16(iter, expr)          _mm512_set_epi32(vec_iter_expr_16(iter, 0, expr))
...
#define vec_loadu_i32_32(ptr)                    vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_loadu_i32_16(((vec_i32_16_t*)(ptr)) + _i);)
#define vec_loadu_i32_16(ptr)                    _mm512_loadu_si512((ptr))
#define vec_loadu_i32_8(ptr)                     _mm256_loadu_si256((ptr))
#define vec_loadu_i32_4(ptr)                     _mm_loadu_si128((ptr))
#define vec_loadu_i32_1(ptr)                     (*((vec_i32_1_t*)(ptr)))

#define vec_storeu_i32_32(ptr, vec)              vec_loop_stmt(2, _i, vec_storeu_i32_16(((vec_i32_16_t*)(ptr)) + _i, (vec).v[_i]);)
#define vec_storeu_i32_16(ptr, vec)              _mm512_storeu_si512((ptr), vec)
#define vec_storeu_i32_8(ptr, vec)               _mm256_storeu_si256((ptr), vec)
#define vec_storeu_i32_4(ptr, vec)               _mm_storeu_si128((ptr), vec)
#define vec_storeu_i32_1(ptr, vec)               do { (*((vec_i32_1_t*)(ptr))) = (vec); } while (0)


#define vec_add_i32_32(a, b)                     vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_add_i32_16(a.v[_i], b.v[_i]);)
#define vec_add_i32_16(a, b)                     _mm512_add_epi32(a, b)
#define vec_add_i32_8(a, b)                      _mm256_add_epi32(a, b)
#define vec_add_i32_4(a, b)                      _mm_add_epi32(a, b)
#define vec_add_i32_1(a, b)                      (a + b)

#define vec_sub_i32_32(a, b)                     vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_sub_i32_16(a.v[_i], b.v[_i]);)
#define vec_sub_i32_16(a, b)                     _mm512_sub_epi32(a, b)
#define vec_sub_i32_8(a, b)                      _mm256_sub_epi32(a, b)
#define vec_sub_i32_4(a, b)                      _mm_sub_epi32(a, b)
#define vec_sub_i32_1(a, b)                      (a - b)


#define vec_mul_i32_32(a, b)                     vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_mul_i32_16(a.v[_i], b.v[_i]);)
#define vec_mul_i32_16(a, b)                     _mm512_mullo_epi32(a, b)
#define vec_mul_i32_8(a, b)                      _mm256_mullo_epi32(a, b)
#define vec_mul_i32_4(a, b)                      _mm_mullo_epi32(a, b)
#define vec_mul_i32_1(a, b)                      (a * b)

#define vec_div_i32_32(a, b)                     vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_div_i32_16(a.v[_i], b.v[_i]);)
#define vec_div_i32_16(a, b)                     ({union {vec_i32_16_t v; uint32_t s[16];} buf_a={.v=a}, buf_b={.v=b}; vec_set_iter_i32_16(_j, buf_a.s[_j] / buf_b.s[_j]);})
...
#define vec_and_i32_32(a, b)                     vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_and_i32_16(a.v[_i], b.v[_i]);)
#define vec_and_i32_16(a, b)                     _mm512_and_si512(a, b)
#define vec_and_i32_8(a, b)                      _mm256_and_si256(a, b)
#define vec_and_i32_4(a, b)                      _mm_and_si128(a, b)
#define vec_and_i32_1(a, b)                      (a & b)

#define vec_or_i32_32(a, b)                      vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_or_i32_16(a.v[_i], b.v[_i]);)
#define vec_or_i32_16(a, b)                      _mm512_or_si512(a, b)
#define vec_or_i32_8(a, b)                       _mm256_or_si256(a, b)
#define vec_or_i32_4(a, b)                       _mm_or_si128(a, b)
#define vec_or_i32_1(a, b)                       (a | b)


#define vec_slli_i32_32(a, imm8)                 vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_slli_i32_16(a.v[_i], imm8);)
#define vec_slli_i32_16(a, imm8)                 _mm512_slli_epi32(a, imm8)
...
#define vec_srli_i32_32(a, imm8)                 vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_srli_i32_16(a.v[_i], imm8);)
#define vec_srli_i32_16(a, imm8)                 _mm512_srli_epi32(a, imm8)
...
#define vec_srai_i32_32(a, imm8)                 vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_srai_i32_16(a.v[_i], imm8);)
#define vec_srai_i32_16(a, imm8)                 _mm512_srai_epi32(a, imm8)
...
#define vec_sllv_i32_32(a, count)                vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_sllv_i32_16(a.v[_i], count.v[_i]);)
#define vec_sllv_i32_16(a, count)                _mm512_sllv_epi32(a, count)
...
#define vec_srlv_i32_32(a, count)                vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_srlv_i32_16(a.v[_i], count.v[_i]);)
#define vec_srlv_i32_16(a, count)                _mm512_srlv_epi32(a, count)
...
#define vec_srav_i32_32(a, count)                vec_loop_expr(__m512i_i32_2, 2, _tmp, _i, _tmp.v[_i] = vec_srav_i32_16(a.v[_i], count.v[_i]);)
#define vec_srav_i32_16(a, count)                _mm512_srav_epi32(a, count)
