...
_TYPE_OUT reduce_segment_parallel(_TYPE_IN * A, long i_start, long i_end, _TYPE_OUT zero, const int backwards);
...
_TYPE_OUT reduce_parallel(_TYPE_IN * A, long N, _TYPE_OUT zero, const int backwards);
...
_TYPE_OUT scan_reduce_segment_parallel(_TYPE_IN * A, _TYPE_OUT * P, long i_start, long i_end, _TYPE_OUT zero, const int start_from_zero, const int backwards);

#undef  scan_reduce_segment
#define scan_reduce_segment  FUNCTOOLS_GEN_EXPAND(scan_reduce_segment)
_TYPE_OUT scan_reduce_segment(_TYPE_IN * A, _TYPE_OUT * P, long i_start, long i_end, _TYPE_OUT zero, const int start_from_zero, const int backwards);


#undef  scan_reduce_serial
#define scan_reduce_serial  FUNCTOOLS_GEN_EXPAND(scan_reduce_serial)
_TYPE_OUT scan_reduce_serial(_TYPE_IN * A, _TYPE_OUT * P, long N, _TYPE_OUT zero, const int start_from_zero, const int backwards);

#undef  scan_reduce_parallel
#define scan_reduce_parallel  FUNCTOOLS_GEN_EXPAND(scan_reduce_parallel)
_TYPE_OUT scan_reduce_parallel(_TYPE_IN * A, _TYPE_OUT * P, long N, _TYPE_OUT zero, const int start_from_zero, const int backwards);

#undef  scan_reduce
#define scan_reduce  FUNCTOOLS_GEN_EXPAND(scan_reduce)
_TYPE_OUT scan_reduce(_TYPE_IN * A, _TYPE_OUT * P, long N, _TYPE_OUT zero, const int start_from_zero, const int backwards);
