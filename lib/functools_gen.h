...
_TYPE_OUT scan_reduce_segment_parallel(_TYPE_IN * A, _TYPE_OUT * P, long i_start, long i_end, _TYPE_OUT zero, const int exclusive, const int backwards);
...
_TYPE_OUT scan_reduce_parallel(_TYPE_IN * A, _TYPE_OUT * P, long N, _TYPE_OUT zero, const int exclusive, const int backwards);
