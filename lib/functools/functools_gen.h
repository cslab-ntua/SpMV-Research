...
#elif !defined(FUNCTOOLS_GEN_FUNCTION_ATTRIBUTES)
	#define FUNCTOOLS_GEN_FUNCTION_ATTRIBUTES
#endif
...
FUNCTOOLS_GEN_FUNCTION_ATTRIBUTES
...
/* Calculates prefix 'sums' (specific operation given).
 *
 * A = P is allowed.
 *
