...
#define HASHTABLE_GEN_EXPAND_TYPE(name)  CONCAT(HASHTABLE_GEN_, HASHTABLE_GEN_EXPAND(name))

#undef  _TYPE_K
#define _TYPE_K  HASHTABLE_GEN_EXPAND_TYPE(_TYPE_K)
...
#undef  _TYPE_BS
#define _TYPE_BS  HASHTABLE_GEN_EXPAND_TYPE(_TYPE_BS)
