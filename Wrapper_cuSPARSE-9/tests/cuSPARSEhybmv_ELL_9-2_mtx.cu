...
int main(int argc, char **argv) {
	...
	sprintf(powa_filename, "cuSPARSE_ellmv_9-2_mtx_cudatype-%d_format-CSR.log", CUDA_VALUE_TYPE_AX);
	...
	NvemStats_p nvem_data = NvemStopMeasure(device_id, "Energy measure cuSPARSE_ellmv_9-2_mtx");
