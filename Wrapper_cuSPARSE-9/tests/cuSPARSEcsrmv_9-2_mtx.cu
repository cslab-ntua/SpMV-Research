...
int main(int argc, char **argv) {
	...
	cudaMemcpy(out, cuSPARSE_op.y, op.m * sizeof(VALUE_TYPE_AX), cudaMemcpyDefault);
	...
	sprintf(powa_filename, "cuSPARSEcsrmv_9-2_mtx_cudatype-%d_format-CSR.log", CUDA_VALUE_TYPE_AX);
	...
	NvemStats_p nvem_data = NvemStopMeasure(device_id, "Energy measure cuSPARSEcsrmv_9-2_mtx");
