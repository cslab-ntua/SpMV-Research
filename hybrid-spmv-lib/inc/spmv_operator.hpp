...
typedef enum {
  SPMV_VALUETYPE_INT = 0,
  SPMV_VALUETYPE_FLOAT,
  SPMV_VALUETYPE_BINARY,
  SPMV_VALUETYPE_DOUBLE
} SpmvValueType;
...
typedef struct { cusparseHybMat_t hybMatrix; } SpmvHybData;
